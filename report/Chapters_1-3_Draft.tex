...
\subsection{Transit Equity and Transit Deserts}
...
\subsection{Urban Walkability and Equity}
...
\subsection{Bicycle Infrastructure Equity}
...
\subsection{Electric-Vehicle Charging Equity}
...
\subsection{Composite Indicators in Public Policy}
...
\subsection{Mobility Equity Score (MES)}
...
\subsection{Weighting Methodology and Sensitivity Analysis}
...
\subsection{Mobility-Desert Classification}
...
\subsection{Reproducibility and Implementation Status}
...
% ============================== REFERENCES ==============================
% (the thebibliography environment emits its own "References" heading)
